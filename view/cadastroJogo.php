...
<form class="row g-3" action="../controler/inserirCadastroJogo.php" method="Get">
  ...
  <div class="col-md-6">
    ...
    <input type="Number" name="valorjogo" class="form-control" id="inputValor" placeholder="XX,XX" required>
  </div>
  <div class="col-md-6">
    <label for="inputGenero" class="form-label">Gênero do Jogo</label>
